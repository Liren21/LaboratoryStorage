...
import static LaboratoryTwo.TextPaint.sANSI_RED;
    ...
    public static void DateInput() {
        ...
        try {
            ...
            if (date3.getTime() < date2.getTime() || date5.getTime() < date4.getTime()) {
                System.out.print(sANSI_RED + "Дата окончания меньше чем дата начала\nПовторите ввод\n");
                DateInput();
            } else {
            ...
            System.out.print(sANSI_RED + "Ошибка: введите корректные данные\n" + sANSI_RED);
            DateInput();
        }
    }
}
